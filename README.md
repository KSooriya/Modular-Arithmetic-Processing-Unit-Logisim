...
- **1-bit & 8-bit Adders** – Perform binary arithmetic operations.
- **Arithmetic Logic Unit (ALU)** – Executes arithmetic and logical computations.
- **Logic Unit** – Manages shift and rotate operations.
- **Instruction Decoder (ID)** – Controls instruction flow and operation selection.
- **General Purpose Register (GPR)** – Temporarily stores data during execution.
- **MPU (Microprocessor Unit)** – Integrates all modules into a unified processing core handling arithmetic, control, and memory interaction.
